	soc_system u0 (
		...
		.i2c_scl_pad_i                         (<connected-to-i2c_scl_pad_i>),                         //                            i2c.scl_pad_i
		.i2c_scl_pad_o                         (<connected-to-i2c_scl_pad_o>),                         //                               .scl_pad_o
		.i2c_scl_padoen_o                      (<connected-to-i2c_scl_padoen_o>),                      //                               .scl_padoen_o
		.i2c_sda_pad_i                         (<connected-to-i2c_sda_pad_i>),                         //                               .sda_pad_i
		.i2c_sda_pad_o                         (<connected-to-i2c_sda_pad_o>),                         //                               .sda_pad_o
		.i2c_sda_padoen_o                      (<connected-to-i2c_sda_padoen_o>)                       //                               .sda_padoen_o
	);
